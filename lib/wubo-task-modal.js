...
(function () {
  ...
  // Pour chaque assignee, trouve/crée son bloc à la date+tranche demandée et y lie la tâche.
  // S'appuie sur WuboGrist.ensureBlocForUserAtDate (centralisé). Retourne info pour pouvoir undo.
  async function autoLinkToAssigneeBlocs(taskId, dateUnix, assignees, preferredTranche) {
    ...
    for (const user of assignees) {
      try {
        const { blocId, created } = await WuboGrist.ensureBlocForUserAtDate(user, dateUnix, preferredTranche);
